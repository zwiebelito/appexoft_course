...
export default class ContactBook extends Component {
    ...
    addContact = ()=>{
        if (this.state.newContact.name.length > 0 && this.state.newContact.phone.length >= 10){
            this.setState((prevState)=>({
        ...
        return <div className="max-w-md mx-auto bg-white p-6 rounded-md shadow-md">
            ...
            <div className="mt-4">
                ...
                <label className="block mb-2">Name:
                    <input placeholder='please enter your name' type="text" className="border border-gray-300 p-2 w-full rounded" name="name" value={newContact.name} onChange={this.handleInputChange}/>
                </label>
                <label className="block mb-2">Phone:
                    <input type="text" placeholder='please enter your phone number (10 digits)' className="border border-gray-300 p-2 w-full rounded" name="phone" value={newContact.phone} onChange={this.handleInputChange}/>
                </label>
